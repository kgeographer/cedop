...
Tasks 1–6 complete (static bands A–E). Tasks 7–10 complete (Band T, 2026-04-25/26, branch explore02).
...
Next: Task 11 (LMR period/volcanic fingerprints — MCA/LIA detection, volcanic response curves, baseline-window convention). **Do not** start correspondence testing until Task 11 complete.
