-- v_basin08_persist_rev1
-- Extends v_basin08_persist with upstream (_u) climate/soil/hydro fields,
-- coastality flags, and the previously-joined-but-unused wetland class.
-- The original v_basin08_persist is left untouched (used by prototype GUI).
...
-- B: Hydroclimatic
  ...
  b.wet_pc_ug1 AS wet_pct_grp1_upstream,   -- NEW
  b.wet_pc_ug2 AS wet_pct_grp2_upstream,   -- NEW
  b.wet_cl_smj AS wetland_class_id,        -- NEW (was joined but not selected)
  w.glwd_name  AS wetland_class,           -- NEW
  b.rev_mc_usu AS reservoir_vol,
  b.cly_pc_sav AS pct_clay,
  b.slt_pc_sav AS pct_silt,
  b.snd_pc_sav AS pct_sand,
  b.cly_pc_uav AS pct_clay_upstream,       -- NEW
  b.slt_pc_uav AS pct_silt_upstream,       -- NEW
  b.snd_pc_uav AS pct_sand_upstream,       -- NEW

-- C: Bioclimatic
  b.tmp_dc_syr / 10.0 AS temp_yr,
  b.tmp_dc_smn / 10.0 AS temp_min,
  b.tmp_dc_smx / 10.0 AS temp_max,
  b.tmp_dc_uyr / 10.0 AS temp_yr_upstream, -- NEW
  b.pre_mm_syr        AS precip_yr,
  b.pre_mm_uyr        AS precip_yr_upstream, -- NEW
  b.ari_ix_sav        AS aridity,
  b.ari_ix_uav        AS aridity_upstream,   -- NEW
...
-- D: Anthropocene
  ...
  b.crp_pc_use AS cropland_extent_upstream, -- NEW
  b.ppd_pk_sav AS pop_density,
  b.hft_ix_s09 AS human_footprint_09,
  b.hft_ix_u09 AS human_footprint_09_upstream, -- NEW
  b.gdp_ud_sav AS gdp_avg,
  b.hdi_ix_sav / 1000.0 AS human_dev_idx,

-- Coastality
  b.dist_sink  AS dist_sink,                -- NEW (flow distance to outlet; convert km in app)
